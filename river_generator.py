class RiverProfileGenerator:
    ...
    def generate_river_profile(self, settings):
        ...
        profile += "WHEN HaveSecondTopPair AND HaveTopKicker RETURN true FORCE\n"
        ...
        profile += "WHEN HadFlushDrawOnTurn AND NOT HaveFlush RETURN true FORCE\n"
        profile += "WHEN HadStraightDrawOnTurn AND NOT HaveStraight RETURN true FORCE\n"
